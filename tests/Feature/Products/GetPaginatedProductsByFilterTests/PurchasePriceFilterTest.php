 ...
 */
class PurchasePriceFilterTest extends TestCase
{
    ...
    public function test_successfull_get_paginated_products_by_filter_purchase_price(): void
    {
    ...
    public function test_get_paginated_products_by_filter_purchase_price_return_empty_array_when_sending_unexisting_purchase_price(): void
    {
        $this->superAdminLogin();
