 ...
 */
class UpdatedAtFilterTest extends TestCase
{
    ...
    public function test_successfull_get_paginated_products_by_filter_updated_at_not_null(): void
    {
    ...
    public function test_successfull_get_paginated_products_by_filter_updated_at_is_null(): void
    {
        $this->superAdminLogin();
    ...
    public function test_get_paginated_products_by_filter_updated_at_return_empty_array_when_sending_unexisting_updated_at(): void
    {
        $this->superAdminLogin();
