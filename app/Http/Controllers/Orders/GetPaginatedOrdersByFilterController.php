            ...
            function (Builder $query) {
                if (array_key_exists("from", $this->sent_filter['created_at'])) {
                    ...
                    try {
                        ...
                        Log::channel('get_paginated_orders_by_filter_errors')->error(
                            "\n\n" .
                            "Description: Failed to get minimum created_at of orders from database.\n\n" .
                ...
                if (array_key_exists("to", $this->sent_filter['created_at'])) {
                    ...
                    try {
                        ...
                        Log::channel('get_paginated_orders_by_filter_errors')->error(
                            "\n\n" .
                            "Description: Failed to get maximum created_at of orders from database.\n\n" .
                            "Error message: " . $th->getMessage() . "\n\n" .
                            "Page: " . (int) $this->global_request_object->get('page', 1) . "\n\n" .
                            "Limit: " . (int) $this->global_request_object->get('limit', 10) . "\n\n" .
                            "User ID: " . $this->global_request_object->get('logged_in_user')->id . "\n\n" .
            ...
            function (Builder $query) {
                if (array_key_exists("from", $this->sent_filter['amount'])) {
                    ...
                    try {
                        ...
                        Log::channel('get_paginated_orders_by_filter_errors')->error(
                            "\n\n" .
                            "Description: Failed to get minimum amount of orders from database.\n\n" .
                            "Error message: " . $th->getMessage() . "\n\n" .
                            "Page: " . (int) $this->global_request_object->get('page', 1) . "\n\n" .
                            "Limit: " . (int) $this->global_request_object->get('limit', 10) . "\n\n" .
                            "User ID: " . $this->global_request_object->get('logged_in_user')->id . "\n\n" .
                ...
                if (array_key_exists("to", $this->sent_filter['amount'])) {
                    ...
                    try {
                        ...
                        Log::channel('get_paginated_orders_by_filter_errors')->error(
                            "\n\n" .
                            "Description: Failed to get maximum amount of orders from database.\n\n" .
                            "Error message: " . $th->getMessage() . "\n\n" .
                            "Page: " . (int) $this->global_request_object->get('page', 1) . "\n\n" .
                            "Limit: " . (int) $this->global_request_object->get('limit', 10) . "\n\n" .
                            "User ID: " . $this->global_request_object->get('logged_in_user')->id . "\n\n" .
    ...
    private function preparePaginatedOrders()
    {
        ...
        try {
            ...
            try {
                Log::channel('get_paginated_orders_by_filter_errors')->error(
                    "\n\n" .
                    "Description: Failed to get paginated orders by filter from database.\n\n" .
                    "Error message: " . $th->getMessage() . "\n\n" .
                    "Page: " . $page . "\n\n" .
                    "Limit: " . $limit . "\n\n" .
                    "User ID: " . $this->global_request_object->get('logged_in_user')->id . "\n\n" .
